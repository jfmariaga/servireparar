...
| 002 — Órdenes de Trabajo | ✅ Completado (2026-08-24) · ⚠️ revisado (2026-09-01) · ✅ **implementado (2026-09-07)** | Umbral de vencimiento configurable; rechazo de salida de equipo reabre la OT a "En curso"; ampliado con numeración `OTSV-`, mano de obra de contratistas y costeo/utilidad neta por OT. **2026-09-01**: mano de obra propia se costea **por día** (`dias_trabajados × valor_día`, valor día = `sueldo/30` del técnico, historizado — spec 004). **2026-09-07**: T001–T049 implementadas end-to-end (32 tests); ver `docs/BITACORA-2026-09-07.md`. |
...
| [002 — Órdenes de Trabajo](specs/002-ordenes-trabajo/tasks.md) | ✅ Completado (2026-08-24) · ✅ **implementado (2026-09-07)**: T001–T049 · ✅ **Phase 11 — endurecimiento del flujo (2026-09-08)**: T050–T098 (multi-insumo, reserva de stock, Bodega de un paso, herramientas, guardias de estado, notificaciones in-app, visibilidad por rol) · ✅ **Phase 12 — ajustes de negocio (2026-09-10)**: T099–T137 (prerrequisitos entre tareas, "Liberar OT" + notificaciones diferidas, insumo al encargado de la tarea, herramientas como préstamo por técnico) · ✅ **Phase 13 — plazos, domicilio, vista del técnico y QA (2026-09-10/12, rama `feature/ot-phase-13`, sin merge)**: plazos por tarea, servicio a domicilio, evidencia + días automáticos, insumo pendiente bloquea iniciar, QA visual con los 5 roles, valores monetarios solo para Administrador, préstamo de herramienta a iniciativa de Bodega, cancelación de OT restringida a Admin una vez hay trabajo realizado, mensajes de validación en español. **244 tests en verde**. Ver [plan Phase 12](docs/PLAN-ENDURECIMIENTO-OT-PHASE-12.md), [bitácora Phase 12/13](docs/BITACORA-2026-09-10.md) y [bitácora 2026-09-12](docs/BITACORA-2026-09-12.md) | US1 + US2 (crear y ejecutar OT) |
...
| [004 — Gestión de Personal](specs/004-gestion-personal/tasks.md) | ✅ Completado (2026-08-24) · ✅ Fase 7 (2026-09-01): sueldo historizado + valor día + hoja de vida (T021–T029, +6 tests) · ✅ US2/US3 (2026-09-15): carga laboral (`Tecnico::tareasActivasCount()`) y `DesempenoTecnicoService` + reporte `/personal/desempeno` (T011–T017, +10 tests) | US1 (ficha de técnico) |
...
| [007 — Reportes e Indicadores](specs/007-reportes-kpis/tasks.md) | ✅ Tareas generadas (2026-08-24) · ✅ **US1+US2 implementado (2026-09-15)**: `IndicadoresAgregadosService` (OT abiertas/cerradas/vencidas, cumplimiento de tiempos, productividad del equipo, trabajo en ejecución) + dashboard de Administrador/Jefe de Taller con auto-refresh `wire:poll` (T002, T007-T012, T020-T021, +8 tests). **Pendiente**: US3 exportación Excel/PDF (T001, T015-T019) | US1 (dashboards por rol) |
