...
| [002 — Órdenes de Trabajo](specs/002-ordenes-trabajo/tasks.md) | ✅ Completado (2026-08-24) · ✅ **implementado (2026-09-07)**: T001–T049 · ✅ **Phase 11 — endurecimiento del flujo (2026-09-08)**: T050–T097 (rama `feature/ot-endurecimiento`; multi-insumo, reserva de stock, Bodega de un paso, herramientas, guardias de estado, notificaciones in-app, visibilidad por rol) — falta T098 (prueba conjunta). Ver [plan](docs/PLAN-ENDURECIMIENTO-OT-2026-09-08.md) y [bitácora](docs/BITACORA-2026-09-08.md) | US1 + US2 (crear y ejecutar OT) |
