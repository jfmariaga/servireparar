...
return [
    ...
    | usa la clase Validator. Algunas reglas tienen varias versiones, como
    | las reglas de tamaño. Se pueden ajustar libremente estos mensajes.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute indicado ha aparecido en una filtración de datos. Por favor elige otro :attribute.',
    ],
    ...
    | atributos usando la convención "atributo.regla" como nombre de línea.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para cambiar el marcador de posición del
    | atributo por algo más legible, como "Dirección de correo" en vez de
    | "email". Cada formulario de SERVIOPS ya define los suyos en línea con
    | el tercer argumento de $this->validate(); esto queda como respaldo.
    |
    */
