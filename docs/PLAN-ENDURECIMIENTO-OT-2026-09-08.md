...
| 8 — Regresión y cierre (T096–T097) | ✅ hecho (2026-09-08). Suite completa: **197 tests en verde** (159 → +38). `docs/BITACORA-2026-09-08.md`. Falta **T098** — protocolo de pruebas de aceptación §4 con los 5 roles (sesión conjunta). |
